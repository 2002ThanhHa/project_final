...
const ChildrentsDentistry = React.lazy(() => import("./components/Services/ChildrentsDentistry"));
const Periodontitis = React.lazy(() => import("./components/Services/Periodontitis"));
...
const RemovableBraces = React.lazy(() => import("./components/Services/RemovableBraces"))
const ClearBraces = React.lazy(() => import("./components/Services/ClearBraces"))
const DentalPartialDenture = React.lazy(() => import("./components/Services/DentalPartialDenture"))
